...
BigNum.prototype.modAdd=function(b){
    ...
    let result=modAddHandle[type](this,b)
    result.removeZero()
    return result
}
...
BigNum.prototype.modSub=function(b){
    ...
    const type=getType(this,b)
    let result=modSubHandle[type](this,b)
    result.removeZero()
    return result
}
...
// console.log(new BigNum('10011').modDiv(new BigNum("222")).toString());


// console.log(new BigNum('49048777605132077232547568428155666688230569284188602580492233424642978193002653271990994565867887445139581802541945099055503063010574104995173297474822195391175960736275445624288014177436395447246232659503886078709708326039667149633507939082').modPow(new BigNum("")).toString());

// console.log(getPrime(100).toString()); 